...
function Start() {
  ...
  wget --no-check-certificate -qO /tmp/Core_Install.sh 'https://raw.githubusercontent.com/hityne/centos/main/Core_Install_v3.1.sh' && chmod a+x /tmp/Core_Install.sh
