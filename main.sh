...
echo ""
echo "  5.Download mydd.sh                            6.PASS"
echo ""
echo "  7.Install 7zip                                8.PASS"
echo ""
echo "  9.Modify SSH Port (for defaut port 22)        a.Install vim and bc"
echo ""
echo "  b.Install screen                              c.Install msmtp"
echo ""
echo "  d.Set localtime to China zone                 e.Install xfce and vnc"
echo ""
